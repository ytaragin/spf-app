...
- [ ] **Phase 1: Test Foundation** - Upgrade Vite 4→6, install and configure Vitest + coverage + shared setup, prove with one trivial test
...
|-------|----------------|--------|-----------|
| 1. Test Foundation | 0/? | Not started | - |
