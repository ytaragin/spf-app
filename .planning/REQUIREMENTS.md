...
- [ ] **EVT-01**: A pure, Vue-free `src/game/gameEvents.js` parses the tagged `{ event, data }` envelope and rejects malformed/unknown envelopes without throwing (unit-tested, no mocking)
