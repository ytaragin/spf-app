<template>
  <div class="play-history">
    <h3>Play History</h3>
    <div v-if="playResults.length === 0" class="no-plays">No plays yet</div>
    <div v-else class="play-list">
      <div v-for="(play, index) in playResults" :key="index" class="play-item">
        <button
          class="play-summary"
          @click="toggle(index)"
          :aria-expanded="isExpanded(index)"
          :aria-controls="'play-details-' + index"
        >
          <div class="indicator">
