...
export const useTeamsStore = defineStore('teams', () => {
  ...
  const team = ref(
    new TeamData({
      ...
      players: { 'QB-1': { name: 'Joe', id: 'QB-1' }, 'RB-1': { name: 'John', id: 'RB-1' } }
    })
  )
  ...
  const getManagedTeam = () => {
    return managedTeam.value
  }
  ...
  function getTeamName(side) {
    ...
    console.warn(`No team data for ${side}, returning fallback`)
  ...
  const availablePlayerIDs = computed(() => {
    let ids = [...team.value.availablePlayerIDs()]
